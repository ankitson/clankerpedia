description: the prompt OpenAI used to solve the 50-year-old Cycle Double Cover Conjecture using 64 subagents in just under one hour using GPT Sol 5.6 Ultra
